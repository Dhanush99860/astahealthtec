        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <Reveal delay={0.07}>
            <h2 className="mt-6 text-balance text-h1 font-semibold leading-[1.06] tracking-[-0.045em] md:text-display">
              <span className="text-ink dark:hidden">{useCasesCta.heading}</span>
              <span
          ...
          <Reveal delay={0.2}>
            <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <Button href={useCasesCta.primaryCta.href} variant="glow" size="xl" trailingIcon>
                {useCasesCta.primaryCta.label}
              </Button>
              <Button href={useCasesCta.secondaryCta.href} variant="secondary" size="xl">
                {useCasesCta.secondaryCta.label}
              </Button>
            </div>
          </Reveal>
        </div>
