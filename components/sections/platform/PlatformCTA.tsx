        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <Reveal delay={0.07}>
            <h2 className="mt-6 text-balance text-h1 font-semibold leading-[1.06] tracking-[-0.045em] md:text-display">
              <span className="text-ink dark:hidden">{platformCta.heading}</span>
              <span
          ...
          <Reveal delay={0.2}>
            <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <Button href={platformCta.primaryCta.href} variant="glow" size="xl" trailingIcon>
                {platformCta.primaryCta.label}
              </Button>
              <Button href={platformCta.secondaryCta.href} variant="secondary" size="xl">
                {platformCta.secondaryCta.label}
              </Button>
            </div>
          </Reveal>
        </div>
