        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <Reveal delay={0.07}>
            <h2 className="mt-6 text-h1 font-semibold leading-[1.06] tracking-[-0.045em] text-balance md:text-display">
              <span className="text-ink dark:hidden">{finalCta.heading}</span>
              <span
          ...
          <Reveal delay={0.20}>
            <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <Button href={finalCta.primaryCta.href} variant="glow" size="xl" trailingIcon>
                {finalCta.primaryCta.label}
              </Button>
              <Button href={finalCta.secondaryCta.href} variant="secondary" size="xl">
